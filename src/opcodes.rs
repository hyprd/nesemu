...
lazy_static! {
    pub static ref Opcodes: Vec<Opcode> = vec![
        Opcode::new(0x69, "ADC", 2, 2, AddressingMode::IMM);
        Opcode::new(0x6D, "ADC", 3, 4, AddressingMode::ABS);
        Opcode::new(0x7D, "ADC", 4, 5, AddressingMode::ABS_X);
        ...
        Opcode::new(0x0E, "ASL", 3, 6, AddressingMode::ZP_X);
        Opcode::new(0x1E, "ASL", 3, 7, AddressingMode::IND_X);
        Opcode::new(0x06, "ASL", 2, 5, AddressingMode::IND_Y);
        Opcode::new(0x16, "ASL", 2, 6, AddressingMode::IND_Y);
        ...
        Opcode::new(0xA2, "LDX", 3, 5, AddressingMode::ABS_Y);
        Opcode::new(0xAE, "LDX", 2, 3, AddressingMode::ZP);
        Opcode::new(0xBE, "LDX", 2, 4, AddressingMode::ZP_X);
        Opcode::new(0xA6, "LDX", 2, 6, AddressingMode::IND_X);
        Opcode::new(0xB6, "LDX", 2, 6, AddressingMode::IND_Y);
        Opcode::new(0xA0, "LDY", 3, 5, AddressingMode::ABS_Y);
        Opcode::new(0xAC, "LDY", 2, 3, AddressingMode::ZP);
        Opcode::new(0xBC, "LDY", 2, 4, AddressingMode::ZP_X);
        Opcode::new(0xA4, "LDY", 2, 6, AddressingMode::IND_X);
        Opcode::new(0xB4, "LDY", 2, 6, AddressingMode::IND_Y);
